...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-kp-4.129-kirby-problem-4.129-16c223ae-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/KP-4.129"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-kp-4.129-kirby-problem-4.129-16c223ae-v1",
      "problem_contract_sha256": "7a61278ecbc94ed913db31b8017ad1ec8f5cbcf74ea416be5a9e5342fbf1b49f",
      "problem_id": "problem:um-kp-4.129-kirby-problem-4.129-16c223ae",
      "route_id": "route:um-kp-4.129-kirby-problem-4.129-16c223ae-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-kp-4.129-kirby-problem-4.129-16c223ae-source-fidelity-01",
      "graph_id": "graph:um-kp-4.129-kirby-problem-4.129-16c223ae-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-kp-4.129-kirby-problem-4.129-16c223ae-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-kp-4.129-kirby-problem-4.129-16c223ae-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Given a closed, 4-dimensional PSC manifold M, is there a (possibly disconnected) 4-dimensional orbifold $M^{1}$ with isolated singularities such that the following hold. (I) The orbifold M1 also admits a metric of positive scalar curvature. (II) All components of $M^{1}$ have finite orbifold-fundamental group. (III) M can be obtained from $M^{1}$ by a series of 0 and 1 surgeries. Here we also allow 0-surgeries between two orbifold points of the same type, which amounts to a removal of two subsets of the for $m D^{4}/\\Gamma$ and an addition of a copy of $S^{3}/\\Gamma \\times$ [0,1]."
          },
          "statement_sha256": "ab62c9ad8325572ae3e25d26d6be82d48cf5a6c9b01c491104adb287d9c43748"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-kp-4.129-kirby-problem-4.129-16c223ae-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-kp-4.129-kirby-problem-4.129-16c223ae-root",
      "route_id": "route:um-kp-4.129-kirby-problem-4.129-16c223ae-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-kp-4.129-cdf2ba007189",
        "url": "https://www.unsolvedmath.com/problems/KP-4.129"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
